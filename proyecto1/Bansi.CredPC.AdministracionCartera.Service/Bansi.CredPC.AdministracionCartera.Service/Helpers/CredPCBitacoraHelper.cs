...
namespace Bansi.CredPC.AdministracionCartera.Service.Helpers
{
    internal class CredPCBitacoraHelper
    {
        ...
        {
            Bansi.CredPC.AdministracionCartera.Service.Datos.Persistence.BdiCredDatabase.BDICredQueries query = new Datos.Persistence.BdiCredDatabase.BDICredQueries();
