...
@Component({
  selector: 'app-bitacora-cambio-monto-linea',
  templateUrl: './bitacora-cambio-monto-linea.component.html',
  styleUrl: './bitacora-cambio-monto-linea.component.scss'
})
export class BitacoraCambioMontoLineaComponent {
  ...
  */
  public MostrarSolicitudes(solicitudes: ResultConsultarSolicitudesCambioLineaResponse[]): void {
    ...
    this.dataSource = new MatTableDataSource<ResultConsultarSolicitudesCambioLineaResponse>(solicitudes);
  }

  /**
   * Recalcular el paginado
   *
   * @public
   */
   ...
   * @param detalle
   */
  DetalleSolicitud(detalle: ResultConsultarSolicitudesCambioLineaResponse) {
    const initialState = {
  ...
  exportarExcel() {
    const request: ReporteDetalleColumnasRequest = {
      idTipoReporte: 2 // Tipo Solicitud Bitacora Cambio Linea
    }
