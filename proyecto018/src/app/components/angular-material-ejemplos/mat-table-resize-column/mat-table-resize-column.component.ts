...
@Component({
  selector: 'app-mat-table-resize-column',
  standalone: false,
  templateUrl: './mat-table-resize-column.component.html',
  styleUrl: './mat-table-resize-column.component.css'
})

export class MatTableResizeColumnComponent{
