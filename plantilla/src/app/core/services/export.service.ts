...
import { AutorizarSolicitudCambioCuentaRequest } from '../models/modificacionCuenta/AutorizarSolicitudCambioCuentaRequest';
import { HttpClient, HttpHeaders } from '@angular/common/http';
import { ReporteDetalleColumnasResponse } from '../models/reportsInterface/ReporteDetalleColumnasResponse';
...
export class ExportService {
  ...
  getColumnasReportes(request: any): Observable<ReporteDetalleColumnasResponse>{
    ...
    return this._httpClient.post<ReporteDetalleColumnasResponse>(`${environment.apiUrl}/Bitacora/ObtenerColumnasReportes`, request, {headers});
  }
